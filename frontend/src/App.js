...
import DisplayResearcher from './components/Researcher/DisplayResearcher'
import EditResearcher from './components/Researcher/EditResearcher'
    ...
    <BrowserRouter>
      ...
      <div>
        <div className="container">
          ...
          <Route exact path="/addresearcher" component={AddResearcher} />
          <Route exact path="/displayattendee" component={DisplayAttendee} />
          <Route exact path="/editattendee" component={EditAttendee} />
          <Route exact path="/displayresearcher" component={DisplayResearcher} />
          <Route exact path="/editresearcher" component={EditResearcher} />
