...
class Login extends Component {
    ...
    handleLoginSubmit(e) {
        ...
        if (this.validateType()) {
            ...
            } else if (this.state.userType === 'editor' || this.state.userType === 'admin') {
                    ...
                    <form class="admin-login-form" onSubmit={this.handleLoginSubmit}>
                         <div class="form-group">
                            <div class="input-group">
                                ...
                                <select className="form-control" onChange={this.onChangeUserType}>
                        ...
                        <div class="form-group text-center">
                            <button type="submit" class="admin-blue-button width-30">Login</button>
                        </div>
